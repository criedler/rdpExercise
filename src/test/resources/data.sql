...
insert into booking_to_supplementary_package (id, amount, end_date, start_date, booking_id, supplementary_package_id) values (1, 10, '2023-06-15', '2023-06-08', 2, 4);
insert into booking_to_supplementary_package (id, amount, end_date, start_date, booking_id, supplementary_package_id) values (2, 10, '2023-06-15', '2023-06-08', 2, 3);
insert into booking_to_supplementary_package (id, amount, end_date, start_date, booking_id, supplementary_package_id) values (3, 1, '2023-06-15', '2023-06-08', 2, 2);